...
#					self.distance[4]= Thumb_distal_bone.center.distance_to(Pinky_distal_bone.center)
					...
					for hand in frame.hands:
						...
						self.distance_performance[0]= self.finger_rest_thumb.distance_to(Thumb_distal_bone.next_joint-hand.palm_position) 
						self.distance_performance[1]= self.finger_rest_index.distance_to(Index_distal_bone.next_joint-hand.palm_position) 
						self.distance_performance[2]= self.finger_rest_middle.distance_to(Middle_distal_bone.next_joint-hand.palm_position) 
						self.distance_performance[3]= self.finger_rest_ring.distance_to(Ring_distal_bone.next_joint-hand.palm_position) 
						self.distance_performance[4]= self.finger_rest_pinky.distance_to(Pinky_distal_bone.next_joint-hand.palm_position) 
